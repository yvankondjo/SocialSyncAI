...
- You must WAIT for the result of the first tool before calling another one.
- Do NOT output parallel tool_calls.
- One tool call per turn -> Wait for result -> Then decide next step.
