  ...
  useEffect(() => {
    if (aiSettings && !localSettings) {
      setLocalSettings({
        ...
        instructions: aiSettings.instructions || null,
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={currentSettings?.ai_enabled_for_chats ?? true}
              onCheckedChange={(checked: boolean) => handleSettingChange("ai_enabled_for_chats", checked)}
