...
import { CheckCircle, Plus, Plus as Star, Plus as Zap, AlertCircle, User, Plus as MessageSquare, Plus as ImageIcon, Plus as Mic } from "lucide-react"
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold">SocialSyncAI</span>
          </div>
      ...
      <section className="bg-primary/5 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Rejoignez des milliers d'entreprises qui utilisent SocialSyncAI pour automatiser leur présence sociale.
          </p>
          <Button size="lg" onClick={handleViewPricing} className="px-8">
      ...
      <footer className="border-t py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="font-semibold">SocialSyncAI</span>
          </div>
          <p className="text-center text-muted-foreground mt-4">
            © 2025 SocialSyncAI. Tous droits réservés.
          </p>
        </div>
      </footer>
    </div>
