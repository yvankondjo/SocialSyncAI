...
import {
  Plus,
  Plus as Edit, // Replaced Edit, Pencil
  Trash2, // Keep Trash2 as it exists
  Plus as MessageSquare, // Replaced MessageSquare
  Plus as Hash, // Replaced Tag, Hash
  Plus as Globe, // Replaced Globe
  Plus as ToggleLeft, // Replaced ToggleLeft
  Plus as ToggleRight, // Replaced ToggleRight
} from "lucide-react"
  ...
  const saveExample = async (formData: any) => {
    try {
      ...
      const faqData = {
        ...
        questions: [formData.question.trim()], // Changed from question to questions array
                ...
                <div key={example.id} className="p-4 hover:bg-muted/50 transition-colors">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        ...
                        <Badge variant="outline" className="text-xs flex-shrink-0">
                          ...
                          {'FR'} {/* Removed lang_code and language as they don't exist on FAQQA */}
                        </Badge>
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                        ...
                        {example.context && Array.isArray(example.context) && example.context.length > 0 && (
                          <div className="flex items-center gap-1">
                            <Hash className="w-3 h-3" /> {/* Replaced Tag */}
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      >
                        <Edit className="w-4 h-4" /> {/* Replaced Edit */}
                      ...
                      <Button 
                        ...
                        disabled={isLoading}
                      >
                        <Trash2 className="w-4 h-4" /> {/* Keep Trash2 */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select name="language" defaultValue="fr"> {/* Removed selectedExample?.language as it doesn't exist on FAQQA */}
              ...
              <div>
                ...
                {/* Changed from question to questions[0] */}
                <Textarea
                  name="question"
                  placeholder="Enter the user's question..."
                  defaultValue={selectedExample?.questions?.[0] || ""}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted/30 p-4 rounded-lg">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  ...
                  {/* Removed language as it doesn't exist on FAQQA */}
                  <div><strong>Language:</strong> {"FR"}</div>
                  {/* Changed from question to questions[0] */}
                  <div><strong>Question:</strong> {selectedExample?.questions?.[0]?.substring(0, 50) || "Not set"}{selectedExample?.questions?.[0] && selectedExample.questions[0].length > 50 ? "..." : ""}</div>
